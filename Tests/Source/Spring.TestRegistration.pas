...
{$DEFINE TEST_AUX}
const
  DoRegisterBase = {$IFDEF TEST_BASE}True{$ELSE}False{$ENDIF};
  DoRegisterCore = {$IFDEF TEST_CORE}True{$ELSE}False{$ENDIF};
  DoRegisterAux = {$IFDEF TEST_AUX}True{$ELSE}False{$ENDIF};
begin
